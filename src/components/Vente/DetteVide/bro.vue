                    ...
                    <table class="table table-bordered  table-striped table-hover text-center" id="datatable" width="100%" cellspacing="0">
                        <thead>                              
                          <tr>                    
                           ...
                           <!--<th scope="col">Stock</th>--> 
                            ...
                            <th scope="col">Dette A payé</th>
                            <th scope="col">Montant Amenée</th>
                            <th scope="col">Dette Payés</th>
                        ...
                        <tbody>
                           <tr v-for="money in DetteMoney" :key="money.id">
                            ...
                            <td>{{ money.products.product_name }} </td>
                            <td>{{ money.lot_id }}Fbu</td>
                           <!--<td>{{ reception.stock_id }} </td>--> 
                            <td>{{ money.quantity }} </td>            
                            <td>{{ money.tva }} </td>            
                            <td>{{ money.date_achat }}</td>            
                            <td>{{ money.montant }}</td>            
                            <td>{{ money.montant_total }}</td>                      
                            <td>
